      ...
      <div className={styles.footerContainer}>
        ...
        <div className={styles.infoSection}>
          <div className={styles.studioInfo}>
            <h3 className={styles.studioName}>JM Fitness Studio</h3>
            <p className={styles.address}>
              📍 Rua General Câmara, 18, sala 311, 25 de Agosto, Duque de Caxias
              - RJ
            </p>
        ...
        <div className={styles.copyrightSection}>
          <div className={styles.developer}>
            <img
              ...
              className={styles.bgmLogo}
            />
            <span className={styles.developedBy}>
              Sistema desenvolvido pela{" "}
              <span className={styles.highlight}>BGM Tecnologia Web</span>
            </span>
          </div>
